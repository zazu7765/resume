...
\renewcommand{\maketitle}{
              \begin{center}
                  ...
                  \href{https://github.com/zazu7765}{github.com/zazu7765} % Github URL
                  | \href{https://linkedin.com/in/ibada}{linkedin.com/in/ibada} % Linkedin URL
              \end{center}
...
\begin{customS}
    ...
    {Toronto, Canada}
\item Designed and programmed an Arduino-based control system to trigger electrical signals for valve actuation.
\item Processed sensor data on a Linux system accurately and reliably using a LabJack data acquisition unit in C++ and developed GUIs for data visualization in Python. 
