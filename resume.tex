...
\item Proficient in processing sensor data on a computer using a LabJack data acquisition unit and developing GUIs for data visualization. 
...
\begin{customS}
    ...
    {}
\item nitiated collaborations with school districts in Southern California via cold emailing.
